...
var lineToAdd3 = '            <HintPath>..\\..\\plugins\\com.adjust.sdk\\src\\windows\\AdjustWP81WinRT\\AdjustWP81WinRT\\bin\\Release\\AdjustWinRT.winmd</HintPath>';
var lineToAdd4 = '            <IsWinMDFile>true</IsWinMDFile>';
var lineToAdd5 = '        </Reference>';
var lineToAdd6 = '    </ItemGroup>';

var adjustReference = 'plugins\\com.adjust.sdk\\src\\windows\\AdjustWP81WinRT\\AdjustWP81WinRT\\bin\\Release\\AdjustWinRT.winmd';
var projFilePath = path.join(__dirname,'../../../platforms/windows/CordovaApp.Phone.jsproj');
...
if (newJsprojContent.length > 0) {
    ...
    console.log("Adjust SDK references successfully added to Windows Phone 8.1 project.");
} else {
    console.log("Adjust SDK references already added to Windows Phone 8.1 project.");
}
